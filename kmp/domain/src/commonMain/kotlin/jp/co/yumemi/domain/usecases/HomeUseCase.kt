...
interface HomeUseCase : UseCase<HomeUseCase.Args, HomeEntity> {
...
class HomeExecutor(
    ...
    override suspend fun execute(arguments: HomeUseCase.Args): HomeEntity = homeRepository.getHomeWorkList(id = arguments.id)
}
